    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[1000]">
      ...
      <div className="bg-white rounded-lg p-10 w-full max-w-[500px] shadow-xl">
        ...
        <form className="login-form" onSubmit={handleLogin}>
          ...
          <div className="mb-5">
            {/* Email label */}
            <label htmlFor="email" className="block mb-2 font-medium">{t.email || 'Email'}</label>
          ...
          <div className="mb-5">
            {/* Password label */}
            <label htmlFor="password" className="block mb-2 font-medium">{t.password || 'Password'}</label>
          ...
          <div className="mb-5 flex justify-between items-center">
            ...
            <div>
              ...
              <label htmlFor="remember" className="ml-2 font-medium">
                {t.rememberMe || 'Remember Me'} {/* Translation or fallback text */}
              </label>
            </div>
            
            {/* Forgot password link */}
            <a href="#" className="text-primary no-underline">{t.forgotPassword || 'Forgot Password?'}</a>
          </div>
